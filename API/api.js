...
// export const getNewsAPI = (category, country = "in") => {
//   return `https://newsapi.org/v2/top-headlines?category=${category}&country=${country}&apiKey=2dda6b301d3f4c97b306a701e1c3c028`;
//   // return `${BASE_URL}/top-headlines/category/${category}/${country}.json`;
// };

// export const getSourceAPI = (source) => {
//   return `https://newsapi.org/v2/top-headlines/${sources}?apiKey=2dda6b301d3f4c97b306a701e1c3c028`;
// };
export const getSourceAPI = (source) => {
